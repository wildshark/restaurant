                        ...
                        <div class="product-thumbnail-wrapper">
                            <div class="single-thumbnail-slider">
                                <div class="slider-item">
                                    <img src="assets/page/img/shop/single-1.png" alt="item">
                                </div>
                                <div class="slider-item">
                                    <img src="assets/page/img/shop/single-2.png" alt="item">
                                </div>
                                <div class="slider-item">
                                    <img src="assets/page/img/shop/single-3.png" alt="item">
                                </div>
                                <div class="slider-item">
                                    <img src="assets/page/img/shop/single-4.png" alt="item">
                                </div>
                                <div class="slider-item">
                                    <img src="assets/page/img/shop/single-5.png" alt="item">
                                </div>
                            </div>
                            <div class="product-thumbnail-carousel">
                                <div class="single-thumbnail-item">
                                    <img src="assets/page/img/shop/1.png" alt="item">
                                </div>
                                <div class="single-thumbnail-item">
                                    <img src="assets/page/img/shop/2.png" alt="item">
                                </div>
                                <div class="single-thumbnail-item">
                                    <img src="assets/page/img/shop/3.png" alt="item">
                                </div>
                                <div class="single-thumbnail-item">
                                    <img src="assets/page/img/shop/4.png" alt="item">
                                </div>
                                <div class="single-thumbnail-item">
                                    <img src="assets/page/img/shop/5.png" alt="item">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="shop-tabs">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <img class="w-100" src="assets/page/img/blog/single-2.png" alt="img">
                                        </div>
                                        <div class="col-6">
                                            <img class="w-100" src="assets/page/img/blog/single-3.png" alt="img">
                                        </div>
                                    </div>
                                    ...
                                    <div class="comment-area">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="assets/page/img/blog/comment.png" alt="img">
                                            </div>
                    ...
                    <div class="related-product-slider owl-carousel style-2">
                        <div class="item">
                            <div class="single-item-wrap">
                                <div class="thumb">
                                    <img src="assets/page/img/product/pizza/1.png" alt="img">
                        ...
                        <div class="item">
                            <div class="single-item-wrap">
                                <div class="thumb">
                                    <img src="assets/page/img/product/pizza/2.png" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-line"></i></a>
                                </div>
                                <div class="wrap-details">
                        ...
                        <div class="item">
                            <div class="single-item-wrap">
                                <div class="thumb">
                                    <img src="assets/page/img/product/burger/1.png" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-line"></i></a>
                                </div>
                                <div class="wrap-details">
